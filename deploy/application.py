...
dir = os.getenv("dir")
#Read the 'concatenated_df.csv' file from the 'dir' directory
df=pd.read_csv(dir+'\\concatenated_df.csv')
df.head()
...
def update_table(bank_name, select_quarter, assets_range):
    ...
    #global table_df #Declare the table_df as a global variable
    
    #Directory to save extract the 'concatenated_df.csv' file and save the 'banking_assets_data.csv' file
    dir = os.getenv("dir")
    #Read the 'concatenated_df.csv' file from the 'dir' directory
    table_df=pd.read_csv(dir+'\\concatenated_df.csv')
    ...
    df_table_dir = r"C:\Users\16193\My Drive\Back Up\The Internationalist Group\Political Economy\Lenin's Imperialism\Concentration of banking\Table and AI\env_bank"
    table_df.to_csv(df_table_dir + r"\banking_assets_data.csv", index=False)
...
df_ai = pd.read_csv(r"C:\Users\16193\My Drive\Back Up\The Internationalist Group\Political Economy\Lenin's Imperialism\Concentration of banking\Table and AI\banking_assets_data.csv") #Load the dataset
